...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	 ...
	 * 背景图片配置
	 * 图片路径支持三种格式：
	 * 1. public 目录（以 "/" 开头，不优化）："/assets/images/banner.png"
	 * 2. src 目录（不以 "/" 开头，自动优化但会增加构建时间，推荐）："assets/images/banner.png"
	 ...
	 * desktop: "assets/images/DesktopWallpaper/d1.png", // 单张图片
	 *
	 * mobile: "https://t.alcy.cc/mp", // 随机图API
	 * mobile: "assets/images/MobileWallpaper/m1.png", // 单张图片
	 *
	...
	banner: {
		...
		homeText: {
			...
			switchable: true,
			// 主页横幅主标题
			title: "Memory Gallery never die!",
			// 主页横幅主标题字体大小
			titleSize: "3.8rem",
			// 主页横幅副标题
			subtitle: [
				"你本不想把事件弄得满城风雨，只是怕自己声音不足够响亮",
				"你也不想什么扳倒对面大老板，只是想作为一个消费者找回自己应有的尊重",
				"倘若你见过的一切将在不久后彻底消失，你是否愿意记录它们消失前的模样？",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
